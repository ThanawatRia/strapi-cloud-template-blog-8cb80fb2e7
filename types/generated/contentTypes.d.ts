...
export interface ApiCustomerCustomer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tax_id: Attribute.BigInteger & Attribute.Unique;
    branch: Attribute.Boolean;
    branch_code: Attribute.BigInteger;
    branch_name: Attribute.String;
    branch_type: Attribute.String;
    contact_id: Attribute.BigInteger & Attribute.Unique;
    ...
    bank_branch: Attribute.String;
    account_type: Attribute.String;
    contact_type: Attribute.String;
    credit_date: Attribute.Date;
    phone: Attribute.BigInteger;
    fax_number: Attribute.BigInteger;
    website: Attribute.String;
    shipping_address: Attribute.String;
    attach_file: Attribute.Media;
    notes: Attribute.Text;
    quotation_id: Attribute.Relation<
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    product_code: Attribute.BigInteger;
    category: Attribute.String;
    main_unit: Attribute.Integer;
    barcode: Attribute.String;
    selling_price: Attribute.Integer;
    vat: Attribute.Integer;
    product_description: Attribute.Text;
    income_account: Attribute.String;
    quantity: Attribute.Integer;
    unit_price: Attribute.Integer;
    doc_num: Attribute.Relation<
      'api::product.product',
      'oneToMany',
      'api::quotation.quotation'
    >;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    customers_ids: Attribute.Relation<
      'api::project.project',
      'oneToMany',
      'api::customer.customer'
    >;
    ref_quotation_id: Attribute.Relation<
      'api::project.project',
      'oneToMany',
      'api::quotation.quotation'
    >;
...
export interface ApiQuotationQuotation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    sales_name: Attribute.String;
    currency: Attribute.String;
    customers_id: Attribute.Relation<
      'api::quotation.quotation',
      'oneToMany',
      'api::customer.customer'
    >;
    ...
    total_after_discount: Attribute.Integer;
    vat_include: Attribute.Boolean;
    grandtotal: Attribute.Integer;
    withholding_tax: Attribute.Integer;
    vat_percent: Attribute.Integer;
    payment_amount: Attribute.Integer;
    electronSignature: Attribute.Boolean;
